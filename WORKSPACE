...
go_repository(
    ...
    sum = "h1:zISenRlqNG7WK8TP3HxZTvv+1Z7JZOUIQvZrOr6pQ2w=",
    version = "v0.10.1",
)

go_repository(
    name = "com_github_fluxcd_pkg_runtime",
    importpath = "github.com/fluxcd/pkg/runtime",
    sum = "h1:4iOpx2j/w15kNemDOnZrF6ugJ/rhSmRu7aI+xn23+BI=",
    version = "v0.12.2",
)
